...
const palettes = {
  dark: {
    ...
    aurora: "radial-gradient(ellipse 50% 100% at 10% 0%, rgba(59, 130, 246, 0.1), transparent 65%), #000000",
    shadow: "shadow-[0_36px_140px_-60px_rgba(10,10,10,0.95)]",
    overlay: "linear-gradient(130deg, rgba(59, 130, 246, 0.05) 0%, transparent 65%)",
  },
  light: {
